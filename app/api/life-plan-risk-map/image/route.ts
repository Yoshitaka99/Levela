...
function buildIdealProductionPrompt(sourcePrompt: string) {
  return [
    ...
    "- Add a full-width soft pink band at the bottom with this exact Japanese message, broken into 3 readable lines: SnsClubで正しい環境でチャレンジする事で / あなたの強みが見つかって / その強みを活かした運用方法をプロの講師から学び、この未来が叶えれる！",
    "",
