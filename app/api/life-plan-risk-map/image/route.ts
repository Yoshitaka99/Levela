...
function buildIdealProductionPrompt(sourcePrompt: string) {
  return [
    ...
    "- Preserve the source prompt's existing composition, people illustrations, family illustration, target-audience person cards, and future-scene visuals. The required bottom message band is the only new addition.",
    "- Prioritize visualized people, family scenes, and target-audience personas over text-heavy blocks.",
    ...
    "- Use no more than 6 short Japanese text labels in the image, except for the required bottom message band.",
    "- Do not draw paragraphs of small Japanese text. Prefer visual structure over text density.",
    "- Add a full-width soft pink band at the bottom with this exact Japanese message, broken into 3 readable lines: SnsClubで正しい環境でチャレンジする事で / あなたの強みが見つかって / その強みを活かした運用方法をプロの講師から学び、この未来を未来を叶えましょう✨",
    "",
