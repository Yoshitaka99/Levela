...
function buildIncomeCalculationRules() {
  return [
    ...
    "・収支計算に入れる収入は、現在すでに発生している本人月収、配偶者月収、ボーナス、すでに安定して発生している確定副業収入だけにする。",
    "・「副業で稼ぎたい」「副業目標」「目標収入」「希望収入」「将来できたら」「目指す」などの未確定金額や副業でのプラス見込みは、収入・年収・差分の計算に絶対に入れない。",
    "・未確定の副業目標は、将来の改善見込みとして扱わず、参考情報としてのみ扱う。",
    "・例：副業で月10万円稼ぎたい → 現在収入にも将来収入にも入れない。副業なしの場合の収支差分として計算する。",
  ].join("\n");
}
